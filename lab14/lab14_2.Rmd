...
swim_carni_aqua_ecto <- list(swimming_vec, carni_vec, aqua_vec, ecto_vec)

# Make the plot:
ggVennDiagram(swim_carni_aqua_ecto, category.names = c("Swim", "Carnivore", "Aquatic", "Ectotherm"))
```
