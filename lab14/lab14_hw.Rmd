...
Box plots are great for showing how the distribution of a numeric variable (e.g. weight) varies among a categorical variable (e.g. alignment).
  ...
  What is your numeric data? weight
  What is your categorical variable? publisher
...
```{r}
questions_list <- list(evil_vec, red_eyes_vec, males_vec, bald_vec)
...
```{r}
# something like:
super_bad_bald_men <- ggVennDiagram(questions_list, category.names = c("evil", "red eyes", "male", "bald"))
super_bad_bald_men
```
